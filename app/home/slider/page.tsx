...
export default function Slides() {
  ...
  //   // Khởi tạo vị trí ban đầu với giá trị tính toán
  //   const slideWidth = slideContainer.querySelector('.slide').offsetWidth; // Lấy chiều rộng của slide
  //   slideContainer.style.transform = `translateX(calc(-${slideWidth * slideIndex}px + 10px))`;
  ...
  const moveSlide = (direction) => {
    const slideContainer = document.getElementById('slideContainer');
    const slideWidth = slideContainer.querySelector('.slide').offsetWidth; // Lấy chiều rộng của một slide
    ...
    slideContainer.style.transform = `translateX(${-newSlideIndex * slideWidth}px)`;
  };
